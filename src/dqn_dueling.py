...
Replaces the standard Q-network with separate V(s) and A(s,a) heads that
share a trunk:
    Q(s, a) = V(s) + ( A(s, a) - mean_a' A(s, a') )

The training loop is identical to DQN+Replay (no target network); the
improvement is purely architectural — the network can learn state values
independently of actions, which helps in states where most actions are
